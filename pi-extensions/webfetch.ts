...
export default function webfetchExtension(pi: ExtensionAPI) {
  pi.registerTool({
    ...
    description:
      ...
      "markdown over HTML, handles GitHub repo/blob/issue/PR and GitLab repo/blob/tree " +
      "links directly, extracts converted sections from URL #fragments, supports optional " +
      "header overrides, probe mode, and a smart strategy that probes first and can " +
