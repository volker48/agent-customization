...
const WebFetchParams = Type.Object({
	url: Type.String({
		description: "Website URL to access (http:// or https://). If scheme is omitted, https:// is assumed.",
		minLength: 1,
	}),
...
export default function webfetchExtension(pi: ExtensionAPI) {
	pi.registerTool({
		name: "webfetch",
		label: "Web Fetch",
		description: "Access a website URL and return page content. Use when the user asks to open or read a webpage.",
